...
CALL set_matching_active_status(10005, @is_possible, @output_text);
SELECT @is_possible;
SELECT @output_text;
SELECT id, is_matching_active FROM member WHERE id = 10005;
...
CALL set_matching_active_status(10004, @is_possible, @output_text);
SELECT @is_possible;
SELECT @output_text;
SELECT id, is_matching_active FROM member WHERE id = 10004;
...
CALL set_matching_active_status(10198, @is_possible, @output_text);
SELECT @is_possible;
SELECT @output_text;
SELECT id, is_matching_active FROM member WHERE id = 10198;
...
CALL set_matching_active_status(10181, @is_possible, @output_text);
SELECT @is_possible;
SELECT @output_text;
SELECT id, is_matching_active FROM member WHERE id = 10181;